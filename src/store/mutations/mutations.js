...
export default {
    ...
    GET_USER_INFO(state, email) {
        if (email) {
            axios
                .post("http://grif-qbit.duckdns.org:8080/api/users/get-by-email", { email: email })
    ...
    CREATE_BOOK(state, book) {
        axios
            .post("http://grif-qbit.duckdns.org:8080/api/books/create", book)
            .catch((error) => {
    ...
    CLEAR_BOOKS_DB() {
        axios
            .get("http://grif-qbit.duckdns.org:8080/api/books/clear")
    ...
    CLEAR_USERS_DB() {
        axios
            .get("http://grif-qbit.duckdns.org:8080/api/users/clear")
    ...
    UPDATE_BOOK(state, newBook) {
        let _ = newBook
        axios
            .put("http://grif-qbit.duckdns.org:8080/api/books/update", {
                setupOptions: {
                    $set: {
                        Id: _.Id,
                        Name: _.Name,
    ...
    CREATE_USER(state, user) {
        axios.post("http://grif-qbit.duckdns.org:8080/api/users/create", user)
    },
    UPDATE_USER(state, newUser) {
        ...
        axios
            .put("http://grif-qbit.duckdns.org:8080/api/users/update",
                {
                    setupOptions,
