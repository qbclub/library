  ...
  <v-container class="startPage d-flex align-center">
    <v-row>
      ...
      <v-col class="col-12 col-sm-6">
        <div>
          <div class="clockbox">
            <svg id="clock" xmlns="http://www.w3.org/2000/svg" width="350" height="350" viewBox="0 0 600 600">
              <g id="face">
                <rect x="75" y="75" width="200" height="200" fill="none" stroke="black" stroke-width="7" />
                <path class="hour-marks"
                  d="M300.5 94V61M506 300.5h32M300.5 506v33M94 300.5H60M411.3 107.8l7.9-13.8M493 190.2l13-7.4M492.1 411.4l16.5 9.5M411 492.3l8.9 15.3M189 492.3l-9.2 15.9M107.7 411L93 419.5M107.5 189.3l-17.1-9.9M188.1 108.2l-9-15.6" />
                <circle class="mid-circle" cx="50" cy="50" r="8.1" />
              </g>
              <g id="hour">
